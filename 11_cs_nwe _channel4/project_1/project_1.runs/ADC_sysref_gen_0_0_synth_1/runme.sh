...
HD_PWD='F:/work_panyanjiao/2306_yth_pingguban/8T8R/project_vivado18.3_YTH2_ADDA_pgb4/project_1/project_1.runs/ADC_sysref_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_sysref_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_sysref_gen_0_0.tcl
