...
HD_PWD='E:/work_panyanjiao/37_YTH2/new_2/pro/ad/project_vivado18.3_YTH2_ADDA_0829/project_1/project_1.runs/ADC_jesd_sysref_rst_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_jesd_sysref_rst_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_jesd_sysref_rst_0.tcl
