...
HD_PWD='E:/work_panyanjiao/37_YTH2/new_2/pro/ad/project_vivado18.3_YTH2_ADDA_0829_debug/project_1/project_1.runs/gt_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gt_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gt_clk.tcl
