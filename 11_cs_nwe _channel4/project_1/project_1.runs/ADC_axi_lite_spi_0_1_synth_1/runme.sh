...
HD_PWD='F:/work_panyanjiao/02_yth_pingguban/8T8R/project_vivado18.3_YTH2_ADDA_pgb4_3/project_1/project_1.runs/ADC_axi_lite_spi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_axi_lite_spi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_axi_lite_spi_0_1.tcl
