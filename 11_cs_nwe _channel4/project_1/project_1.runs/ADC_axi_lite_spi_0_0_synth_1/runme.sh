...
HD_PWD='E:/work_panyanjiao/37_YTH2/new_2/pro/ad/project_vivado18.3_YTH2_AD_0825/project_1/project_1.runs/ADC_axi_lite_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_axi_lite_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_axi_lite_spi_0_0.tcl
