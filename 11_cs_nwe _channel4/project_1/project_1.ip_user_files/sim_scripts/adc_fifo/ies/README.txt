...
#
# Generated by export_simulation on Thu Aug 25 14:39:36 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './adc_fifo.sh' script.

./adc_fifo.sh -reset_run
...
./adc_fifo.sh -noclean_files

For more information on the script, please type './adc_fifo.sh -help'.
