...
#
# Generated by Vivado on Fri May 05 17:26:09 +0800 2023
...
simulate()
{
  xsim dds_compiler_0 -key {Behavioral:sim_1:Functional:dds_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ADC.protoinst" -log simulate.log
}
