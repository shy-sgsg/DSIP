...
#
# Generated by Vivado on Thu Sep 01 20:27:52 +0800 2022
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ADC.protoinst" -log simulate.log
}
