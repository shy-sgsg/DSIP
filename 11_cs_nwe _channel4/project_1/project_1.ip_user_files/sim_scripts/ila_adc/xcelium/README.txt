...
#
# Generated by export_simulation on Thu Aug 10 19:43:32 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './ila_adc.sh' script.

./ila_adc.sh -reset_run
...
./ila_adc.sh -noclean_files

For more information on the script, please type './ila_adc.sh -help'.
