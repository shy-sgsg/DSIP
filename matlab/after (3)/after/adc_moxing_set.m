...
Fstop1 = 750000000;   % First Stopband Frequency
Fpass1 = 790000000;   % First Passband Frequency
Fpass2 = 810000000;   % Second Passband Frequency
Fstop2 = 850000000;   % Second Stopband Frequency
...
numpt = 200000;
code_cx = code_h(40001:240000,:).* exp(-1j*c_x_cha);  %补偿回原始信号复数域
...
numpt = 200000;
code_cx = code_h(40001:240000,:).* exp(-1j*y_data);  %补偿回原始信号复数域
code_cpst = real(code_cx); %获取实部信号
figure;plot(code_cpst) %绘制补偿后的结果
